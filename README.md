...
```console
DOTFILES_BRANCH=beta sh -c "$(wget -qO- https://git.io/brmorris-dotfiles)"
```
...
- [`README.md`](./README.md)
  - Replace all occurrences of `https://git.io/brmorris-dotfiles` with `https://raw.githubusercontent.com/<your-username>/dotfiles/HEAD/scripts/install_dotfiles.sh`
